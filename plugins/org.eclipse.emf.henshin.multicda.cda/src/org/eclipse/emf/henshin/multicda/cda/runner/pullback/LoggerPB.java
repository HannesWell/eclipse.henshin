...
//			String ruleDetails = (addDetailsOnRuleName == true) ? analyseDetailsOfRule(rule1) : "";
			...
			runtimeResults[rowPosition][1] = runtime;// das sind hier die Metriken zur jeweiligen Regel und dies wird f�r jede Regel nur einmal zu Beginn eingetragen!
			numberOfDeleteUseConflicts[rowPosition][1] = results;// das sind hier die Metriken zur jeweiligen Regel und dies wird f�r jede Regel nur einmal zu Beginn eingetragen!
		}
...
//			String ruleDetails = analyseDetailsOfRule(rule2);
				...
				runtimeResults[1][columnPosition] = runtime;// das sind hier die Metriken zur jeweiligen Regel und dies wird f�r jede Regel nur einmal zu Beginn eingetragen!
				numberOfDeleteUseConflicts[1][columnPosition] = results;// das sind hier die Metriken zur jeweiligen Regel und dies wird f�r jede Regel nur einmal zu Beginn eingetragen!
			}
